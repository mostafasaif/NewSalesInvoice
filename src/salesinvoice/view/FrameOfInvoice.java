...
public class FrameOfInvoice extends javax.swing.JFrame {
    ...
    private TableOfLinesModel tableoflinesmodel;

    public TableOfInvoiceModel getTableofinvoicemodel() {
        if(tableofinvoicemodel==null)
        {
           tableofinvoicemodel = new TableOfInvoiceModel(getInvoices());
        }
    ...
    public TableOfLinesModel getTableoflinesmodel() {
    ...
    {
       int number=0;
       for(InvoiceClass invoice : getInvoices())
       {
